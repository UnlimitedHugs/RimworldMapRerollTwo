...
namespace Reroll2.UI {
	public class Widget_ResourceBalance {
		...
		public void DrawLayout() {
			...
			Widgets.FillableBar(barRect, fillPercent/Reroll2Controller.MaxResourceBalance, Resources.Textures.ResourceBarFull, Resources.Textures.ResourceBarEmpty, false);
